...
import { Camera, X, Upload, Check, AlertTriangle, Info, Sparkles } from "lucide-react"
import { motion, AnimatePresence } from "framer-motion"

export function AIFoodRecognition() {
  ...
  const nutritionData = {
    ...
    fat: 12,
    fiber: 8,
    ingredients: ["Rice", "Mixed Vegetables", "Ghee", "Spices", "Cashews"],
    healthScore: 75,
    confidence: 92,
  }
  ...
  return (
    <>
      <Button
        ...
        className="fixed bottom-44 right-4 rounded-full p-4 shadow-lg bg-emerald-500 hover:bg-emerald-600 text-white"
        size="icon"
        aria-label="AI Food Recognition"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <Card className="w-full max-w-2xl shadow-xl border-emerald-200 overflow-hidden max-h-[90vh] flex flex-col">
              ...
              <CardContent className="p-0 flex-1 overflow-auto">
                {!image ? (
                  ...
                  >
                    <div className="h-20 w-20 rounded-full bg-emerald-100 text-emerald-500 flex items-center justify-center mb-4">
                      <Camera className="h-10 w-10" />
                    </div>
                    <h3 className="text-xl font-medium mb-2">Upload Food Image</h3>
                    <p className="text-center text-muted-foreground mb-6 max-w-md">
                      Take a photo of your meal or upload an existing image to get instant nutritional analysis and
                    ...
                    <input
                      ...
                      className="hidden"
                    />
                    <div className="mt-8 p-4 border border-dashed border-emerald-200 rounded-lg text-center bg-emerald-50">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        {!isAnalyzing && (
                          <div className="flex gap-4">
                            <Button className="bg-emerald-500 hover:bg-emerald-600" onClick={analyzeImage}>
                              <Sparkles className="mr-2 h-4 w-4" />
                              Analyze Meal
                            </Button>
                            <Button variant="outline" className="border-emerald-200" onClick={resetAnalysis}>
                        ...
                        {isAnalyzing && (
                          <div className="w-full max-w-md mt-4">
                            ...
                            <p className="text-sm text-center text-muted-foreground mt-2">
                              Identifying dish and analyzing nutritional content...
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      <div>
                        <div className="flex flex-col sm:flex-row gap-6 mb-6">
                          ...
                          <div className="sm:w-2/3">
                            ...
                            <p className="text-emerald-600 font-medium text-lg mb-2">{nutritionData.foodName}</p>
                            <p className="text-muted-foreground mb-4">
                              We've identified this meal with the following nutritional profile:
                            </p>
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                              <div className="bg-emerald-50 p-3 rounded-lg text-center">
                                <div className="text-xl font-bold text-emerald-700">{nutritionData.calories}</div>
                                <div className="text-xs text-muted-foreground">Calories</div>
                              </div>
                              <div className="bg-emerald-50 p-3 rounded-lg text-center">
                                <div className="text-xl font-bold text-emerald-700">{nutritionData.protein}g</div>
                                <div className="text-xs text-muted-foreground">Protein</div>
                              </div>
                              <div className="bg-emerald-50 p-3 rounded-lg text-center">
                                <div className="text-xl font-bold text-emerald-700">{nutritionData.carbs}g</div>
                                <div className="text-xs text-muted-foreground">Carbs</div>
                              </div>
                              <div className="bg-emerald-50 p-3 rounded-lg text-center">
                                <div className="text-xl font-bold text-emerald-700">{nutritionData.fat}g</div>
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <ul className="space-y-2">
                                  ...
                                  <li className="flex items-start">
                                    <Check className="h-5 w-5 text-emerald-500 mr-2 flex-shrink-0 mt-0.5" />
                                    <span>Contains a variety of vegetables providing essential vitamins</span>
                                  </li>
                                  <li className="flex items-start">
                                    <Check className="h-5 w-5 text-emerald-500 mr-2 flex-shrink-0 mt-0.5" />
                                    <span>Cashews provide healthy fats and additional protein</span>
                                  </li>
                                  <li className="flex items-start">
                            ...
                            <div className="space-y-6">
                              <div>
                                ...
                                <div className="flex items-start mt-2">
                                  <Info className="h-5 w-5 text-emerald-500 mr-2 flex-shrink-0 mt-0.5" />
                        ...
                        <div className="flex justify-between mt-6">
                          ...
                          <Button className="bg-emerald-500 hover:bg-emerald-600">Save to Health Log</Button>
                        </div>
                      </div>
                    )}
                  </div>
